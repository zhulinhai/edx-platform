...
class GradeServicesTest(CourseTest):
    ...
    def setUpClass(cls):
        ...
        cls.enhanced_problem_grades_services = ProblemGradeServices(cls.course.id.html_id())


    def test_total_percent_by_section(self):
        grades_by_section = self.grade_services.get_grades_data()
        total_by_section = sum(x['percent'] for x in grades_by_section[0]['section_grades'])
        self.assertAlmostEqual(grades_by_section[0]['percent'], total_by_section)


    def test_max_possible_percent_total(self):
        MAX_POSSIBLE_PERCENT_PER_COURSE = 1.00
        grades_by_section = self.grade_services.get_grades_data()
        max_possible_percent_total = sum(x['max_possible_percent'] for x in grades_by_section[0]['section_grades'])
        self.assertAlmostEqual(max_possible_percent_total, MAX_POSSIBLE_PERCENT_PER_COURSE)


    def test_by_section_report_keys(self):
        by_section_data = self.by_section_grades_services.generate_grade_report_by_section()
        self.assertIn('section_grades', by_section_data[0])
        self.assertIn('up_to_date_grade', by_section_data[0])


    def test_enhanced_problem_grade_key(self):
        problem_grade_report = self.enhanced_problem_grades_services.generate_problem_grade_report()
    ...
    def test_up_to_date_grade_in_all_sections(self):
        ...
        total_percent = grades_by_section[0]['percent']
    ...
    def test_important_keys_in_section_filtered(self):
        grades_by_section = self.grade_services.get_grades_data()
        for item in grades_by_section[0]['section_filtered']:
    ...
    def test_total_sections_dropped(self):
        ...
        dropped_sections = list(x for x in grades_by_section[0]['section_breakdown'] if 'mark' in x)
    ...
    def test_total_sections_unreleased(self):
        ...
        section_filtered = grades_by_section[0]['section_filtered']
    ...
    def test_total_assignment_types_per_section(self):
        grades_by_section = self.grade_services.get_grades_data()
        section_breakdown = grades_by_section[0]['section_grades']
    ...
    def test_by_section_report(self):
        grades_by_section = self.by_section_grades_services.generate_grade_report_by_section()
        self.assertIn('section_grades', grades_by_section[0])
        self.assertIn('up_to_date_grade', grades_by_section[0])
        # 3, is the total of sections in the course, included unreleased section.
        self.assertEquals(len(grades_by_section[0]['section_grades']), 3)
        up_to_date_grade_percent = grades_by_section[0]['up_to_date_grade']['percent']
        up_to_date_grade_section = grades_by_section[0]['up_to_date_grade']['calculated_until_section']
        ...
        grades = grades_by_section[0]['section_grades']
    ...
    def test_by_assignment_type_report(self):
        grades_by_assignment_type = self.by_assignment_type_services.generate_grade_report_by_assignment_type()
        self.assertIn('section_grades', grades_by_assignment_type[0])
        # The sum of max_possible_grade at every assignment type,
        # must be equal to max_possible_percent in that section.
        first_course_section = grades_by_assignment_type[0]['section_grades'][0]
        ...
        second_course_section = grades_by_assignment_type[0]['section_grades'][1]
        ...
        third_course_section = grades_by_assignment_type[0]['section_grades'][2]
    ...
    def test_enhanced_problem_grade_report(self):
        enhanced_problem_grades = self.enhanced_problem_grades_services.generate_problem_grade_report()
