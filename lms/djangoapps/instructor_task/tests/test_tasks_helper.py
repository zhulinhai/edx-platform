...
class SensitiveMessageTestCase(TestCase):
    """
    Test the three methods of the SensitiveMessageOnReports class.
    """
    ...
    def test_build_csv_directly_with_flag(self, process_message_mock):
        ...
        from template is parsed when when flag is True.

        This method is the only one that verify if executes or not depending on the flag,
        the rest are verified directly in the CSV constructors methods.
        """
