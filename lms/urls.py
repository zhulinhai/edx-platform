...
# Submissions feature for espol.
# This url seems to be duplicated at: 'openassessment/fileupload'
urlpatterns += (
    url(r'^submissions_attachments/(?P<key>.+)/$', 'openassessment.fileupload.views_filesystem.filesystem_storage', name='openassessment-filesystem-storage'),
)
