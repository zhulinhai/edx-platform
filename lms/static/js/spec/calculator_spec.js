(function(Calculator) {
    ...
    describe('selectHint', function() {
      it('select correct hint item', function() {
        ...
        expect(this.calculator.hintPopup).toHaveAttr('aria-activedescendant', element.attr('id'));
      });
    ...
    return describe('calculate', function() {
      ...
      it('update the calculator output', function() {
        expect($('#calculator_output').val()).toEqual('3');
      });
    });
  });

}).call(this, Calculator);  // jshint ignore:line
