                    ...
                    fields: [
                        ...
                        emailFieldView,
                        {
                            view: new AccountSettingsFieldViews.TextFieldView({
                                ...
                                helpMessage: StringUtils.interpolate(
                                    gettext('El número de DNI'),  // eslint-disable-line max-len
                                    {platform_name: platformName}
                                ),
                                persistChanges: true
                            })
                        },
                        {
                            view: new AccountSettingsFieldViews.TextFieldView({
                                model: userAccountModel,
                                title: gettext('Teléfono'),
                                valueAttribute: 'location',
                                helpMessage: StringUtils.interpolate(
                                    gettext('El número de teléfono'),  // eslint-disable-line max-len
                                    {platform_name: platformName}
                                ),
                                persistChanges: true
                            })
                ...
                },
                {
                    ...
                    fields: [
                        ...
                        },
                        {
                            view: new AccountSettingsFieldViews.DropdownFieldView({
                                model: userAccountModel,
                                title: gettext('Mes de nacimiento'),
                                valueAttribute: 'month_of_birth',
                                options: [["1", "Enero"],["2", "Febrero"],["3", "Marzo"],["4", "Abril"],["5", "Mayo"],["6", "Junio"],["0", "Julio"],["8", "Agosto"],["9", "Septiembre"],["10", "Octubre"],["11", "Noviembre"],["12", "Diciembre"]],
                                persistChanges: true
                            })
                        },
                        {
                            view: new AccountSettingsFieldViews.DropdownFieldView({
                                model: userAccountModel,
                                title: gettext('Dia de nacimiento'),
                                valueAttribute: 'day_of_birth',
                                options: [["1", "01"],["2", "02"],["3", "03"],["4", "04"],["5", "05"],["6", "06"],["7", "07"],["8", "08"],["9", "09"],["10", "10"],["11", "11"],["12", "12"],["13", "13"],["14", "14"],["15", "15"],["16", "16"],["17", "17"],["18", "18"],["19", "19"],["20", "20"],["21", "21"],["22", "22"],["23", "23"],["24", "24"],["25", "25"],["26", "26"],["27", "27"],["28", "28"],["29", "29"],["30", "30"],["31", "31"]],
                                persistChanges: true
                            })
                        },
                        {
