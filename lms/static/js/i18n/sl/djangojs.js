...
(function (globals) {
  ...
  django.catalog = {
    ...
    "Additional posts could not be loaded. Refresh the page and try again.": "No se pudo cargar publicaciones adicionales. Recargue la p\u00e1gina e intente nuevamente.", 
    "Additional responses could not be loaded. Refresh the page and try again.": "No se pudo cargar respuestas adicionales. Recargue la p\u00e1gina e intente nuevamente.", 
    ...
    "Answers to this problem are now shown. Navigate through the problem to review it with answers inline.": "Ahora se muestran respuestas a este problema. Navega tras el problema para revisarlo con respuestas mostradas.", 
    ...
    "Error resetting problem attempts for problem '<%= problem_id %>' and student '<%- student_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Error al reiniciar los env\u00edos para el problema '<%= problem_id %>' y estudiante '<%- student_id %>'. Aseg\u00farese de que los identificadores del problema y el estudiante sean completos y correctos.", 
    ...
    "No posts matched your query.": "Ninguna publicaci\u00f3n coincide con los criterios datos.", 
    ...
    "Remove {video_name} video": "Eliminar video {video_name} ", 
    "Removing": "Eliminando", 
    "Removing a video from this list does not affect course content. Any content that uses a previously uploaded video ID continues to display in the course.": "Eliminar un video de esta lista no afecta el contenido del curso. Cualquier contenido que usa un ID de un video cargado con anterioridad se seguir\u00e1 mostrando en el curso.", 
    "Replace": "Reemplazar", 
    ...
    "Responses could not be loaded. Refresh the page and try again.": "No se pudo cargar respuestas. Recargue la p\u00e1gina e intente nuevamente.", 
    ...
    "Started entrance exam rescore task for student '{student_id}'. Click the 'Show Task Status' button to see the status of the task.": "Iniciada tarea de recalificaci\u00f3n de ex\u00e1men de ingreso para estudiante '{student_id}'. Clic en el bot\u00f3n 'Mostrar estado de tareas' para ver el estado de la tarea.", 
    ...
    "Subject": "Tema", 
    "Subject:": "Asunto:", 
    "Submission aborted! Sorry, your browser does not support file uploads. If you can, please use Chrome or Safari which have been verified to support file uploads.": "\u00a1El registro fue abordado!. Lo sentimos tu navegador no soporta la carga de archivos. Si puede, por favor utilice Chrome o Safari que han sido verificados para soportar la carga de archivos.", 
    "Submit": "Enviar", 
    ...
    "The post you selected has been deleted.": "La publicaci\u00f3n que seleccion\u00f3 ha sido borrado.", 
    ...
    "This post could not be flagged for abuse. Refresh the page and try again.": "No se pudo marcar esta publicaci\u00f3n como abusivo. Recargue la p\u00e1gina e intente nuevamente.", 
    "This post could not be pinned. Refresh the page and try again.": "No se pudo sujetar esta publicaci\u00f3n. Recargue la p\u00e1gina e intente nuevamente.", 
    ...
    "This post could not be unflagged for abuse. Refresh the page and try again.": "No se pudo desmarcar esta publicaci\u00f3n como abusivo. Recargue la p\u00e1gina e intente nuevamente.", 
    "This post could not be unpinned. Refresh the page and try again.": "No se pudo desprender esta publicaci\u00f3n como sujetada. Recargue la p\u00e1gina e intente nuevamente.", 
    ...
    "This problem has been reset.": "Este problema se ha restablecido.", 
    ...
    "This response could not be marked as endorsed. Refresh the page and try again.": "No se pudo marcar esta respuesta como respaldado. Recargue la p\u00e1gina e intente nuevamente. ", 
    "This response could not be unendorsed. Refresh the page and try again.": "No se pudo desmarcar esta respuesta como respaldado. Recargue la p\u00e1gina e intente nuevamente.", 
    ...
    "This vote could not be processed. Refresh the page and try again.": "Esta votaci\u00f3n no se pudo procesar. Recargue la p\u00e1gina e intente nuevamente.", 
    ...
    "You did not select any files to submit.": "No ha seleccionado ning\u00fan archivo a enviar", 
    ...
    "You have successfully signed into %(currentProvider)s, but your %(currentProvider)s": "Ha iniciado sesi\u00f3n exitosamente en %(currentProvider)s, pero su %(currentProvider)s", 
    ...
    "{filename} exceeds maximum size of {maxFileSizeInGB} GB.": "El archivo {filename} excede el tama\u00f1o maximo de  {maxFileSizeInGBs} GB.", 
    "{hours}:{minutes} (current UTC time)": "{hours}:{minutes} (hora UTC actual)", 
    "{label}: {status}": "{label}: {status}", 
    "{organization}\\'s logo": "Logo de la {organization}", 
    "{paragraphStart}You entered {boldStart}{email}{boldEnd}. If this email address is associated with your {platform_name} account, we will send a message with password reset instructions to this email address.{paragraphEnd}": "{paragraphStart}Ud. ingres\u00f3 {boldStart}{email}{boldEnd}. Si esta direcci\u00f3n de email es asociada con su cuenta en {platform_name}, enviaremos un mensaje con instrucciones para reestablecer su contrase\u00f1a a esta direcci\u00f3n.{paragraphEnd}", 
