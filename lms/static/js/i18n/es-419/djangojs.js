...
(function (globals) {
  ...
  django.catalog = {
    ...
    "%(num_points)s point possible (ungraded)": [
      ...
      "%(num_points)s puntos posibles (no calificado)"
    ], 
    "%(num_points)s point possible (ungraded, results hidden)": [
      "%(num_points)s punto posible (no calificado, resultados escondidos)", 
    ...
    "%(num_students)s student opened Subsection": [
      "%(num_students)s estudiantes abri\u00f3 la subsecci\u00f3n", 
    ...
    "(Community TA)": "(Asistente de ense\u00f1anza de la comunidad)", 
    ...
    "Add a clear and descriptive title to encourage participation. (Required)": "Agregar un t\u00edtulo claro y descriptivo para fomentar la participaci\u00f3n. (Requisito)", 
    ...
    "Date Placed": "Fecha de Efectuaci\u00f3n", 
    ...
    "Learners never see whether their answers to assessments are correct or incorrect, nor the score received.": "Los estudiantes nunca sen si sus respuestas a las asignaciones son correctas o incorrectas, no hay un puntaje recibido.", 
    ...
    "Load next {num_items} result": [
      "Cargar el siguientes {num_items} resultado", 
    ...
    "There was an error when trying to add learners:": [
      "Hubo un error al tratar de agregar al estudiante:", 
    ...
    "You have not bookmarked any courseware pages yet": "No has marcado ninguna p\u00e1gina del curso todav\u00eda", 
    ...
    "Your export has failed.": "Tu exportaci\u00f3n ha fallado.", 
    ...
    "Your question or idea (required)": "Tu pregunta o idea (requisito)", 
    ...
    "{numMoved} learner was moved from {prevCohort}": [
      "{numMoved} estudiante fue movidos de {prevCohort}", 
    ...
    "{numPreassigned} learner was pre-assigned for this cohort. This learner will automatically be added to the cohort when they enroll in the course.": [
      "{numPreassigned} estudiante fue asignado previamente a este cohorte. Este estudiante ser\u00e1 agregado autom\u00e1ticamente a esta cohorte cuando se inscriba en el curso.", 
    ...
    "{numUsersAdded} learner has been added to this cohort. ": [
      "{numUsersAdded} estudiante ha sido agregado a esta cohorte.", 
      "{numUsersAdded} estudiantes han sido agregados a esta cohorte."
    ], 
    "{numVotes} Vote": [
      "{numVotes} Voto", 
      "{numVotes} Votos"
