...
def compose_and_send_activation_email(user, profile, user_registration=None):
    ...
    send_mailX(subject, message_for_activation, from_address, [user.email], html_message=message_for_activation_html) # MH
...
def _do_create_account(form, custom_form=None):
    ...
    profile_fields = [
        ...
        "year_of_birth","location","month_of_birth","day_of_birth","bio"
    ]
    profile = UserProfile(
        user=user,
