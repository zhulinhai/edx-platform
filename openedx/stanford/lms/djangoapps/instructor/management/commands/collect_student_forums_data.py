...
from openedx.stanford.lms.djangoapps.instructor_task.tasks_helper import collect_student_forums_data
...
class Command(BaseCommand):
    ...
    help = ('Usage: collect_student_forums_data <course_id> --output-dir=<output_dir>')
    args = '<course_id>'
